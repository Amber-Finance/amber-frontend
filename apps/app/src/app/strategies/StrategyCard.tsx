  ...
  return (
    ...
    >
      ...
      <CardContent className='relative space-y-4 z-20 flex-1 flex flex-col'>
        ...
        <div className='text-center'>
          <div className='text-6xl font-funnel font-bold text-foreground mb-2'>
            ...
            <span className={`text-2xl ${netApy >= 0 ? 'text-green-500' : 'text-red-500'}`}>%</span>
          </div>
        ...
        <div className='grid grid-cols-2 gap-4 pt-3'>
          <div className='bg-secondary/20 rounded-lg p-3 text-center border border-border/40'>
            <p className='text-muted-foreground text-xs uppercase tracking-wider mb-1'>Base APY</p>
            <p
      ...
      <CardFooter className='relative z-20 pt-3'>
        {!isWalletConnected && (
          <Button onClick={connect} variant='default' className='w-full'>
            Connect Wallet
          </Button>
        )}
