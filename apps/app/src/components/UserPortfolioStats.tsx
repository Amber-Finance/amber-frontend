    ...
    <div className='mb-6 px-4 lg:px-0'>
      <div className='flex flex-col sm:flex-row sm:justify-between sm:items-center'>
        <div className='flex flex-col sm:flex-row sm:space-x-8 space-y-4 sm:space-y-0'>
          {/* Net Worth */}
          <div>
            <div className='mb-1 text-sm text-muted-foreground'>Net worth</div>
            <div className='text-xl font-medium text-foreground'>
              <FormattedValue value={netWorthUSD.toString()} isCurrency={true} />
            </div>
          </div>

          {/* Net APY */}
          <div>
            <div className='mb-1 text-sm text-muted-foreground'>Net APY</div>
            <div
            ...
            >
              <FormattedValue value={netApy.toString()} suffix='%' maxDecimals={2} />
            </div>
          </div>
          {healthFactor && (
            <div>
              <div className='mb-1 text-sm text-muted-foreground'>Health Factor</div>
