...
export default function MarketDetailsSkeleton() {
  return (
    <div className="container mx-auto p-6">
      ...
      <div className="flex items-center mb-8 bg-white/80 dark:bg-zinc-900/80 backdrop-blur-sm p-6 rounded-lg">
        <div className="mr-4">
      ...
      <div className="bg-white/80 dark:bg-zinc-900/80 backdrop-blur-sm rounded-lg p-6 mb-8">
