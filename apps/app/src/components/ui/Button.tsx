...
const buttonVariants = cva(
  'inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none cursor-pointer',
  {
    variants: {
      variant: {
        default:
          'bg-gradient-to-r from-gradient-start to-gradient-end hover:bg-gradient-to-r hover:from-gradient-end hover:to-gradient-start text-foreground shadow disabled:opacity-50 font-bold transition-all duration-300',
        outline:
