...
- **Protocol lending**: Earn interest by lending your Bitcoin BRTs to other users
- **BRT staking rewards**: Native staking yields from the underlying BRT protocols (Lombard, Solv, Bedrock, etc.)
- **Points campaigns**: Additional rewards in Mars Fragments and Neutron Points
...
Amber Finance supports multiple Bitcoin BRTs with current yields:

| BRT | Protocol | Staking APY | Points Multiplier | Total APY* |
|-----|----------|-------------|-------------------|------------|
| **LBTC** | Lombard Finance | ~2.5% | 4× | ~10.0% |
| **solvBTC** | Solv Protocol | ~3.2% | 4× | ~12.8% |
| **uniBTC** | Bedrock | ~2.8% | 3× | ~8.4% |
| **wBTC** | Eureka | ~2.1% | TBC | TBC |
| **wBTC.axl** | Axelar | ~1.9% | TBC | TBC |
| **pumpBTC** | Pump Protocol | ~4.1% | 2× | ~8.2% |
| **eBTC** | Ether.fi | ~3.8% | 3× | ~11.4% |

*Total APY includes staking rewards + points campaigns. Rates are approximate and subject to change.
...
2. **Deposit your BRTs** using our [depositing guide](/user-guide/depositing)
3. **Start earning** from [points campaigns](/user-guide/points-campaigns) and staking rewards
...
- **Most Bitcoin BRTs**: 0.001 tokens (about $100-$200 at current prices)
...
- **Suggest features** through Discord
...
### What are the liquidation parameters?

Liquidation parameters vary by asset but generally:

- **Liquidation threshold**: 85-90% of collateral value
- **Liquidation penalty**: 5-10% of liquidated amount
- **Health factor trigger**: Below 1.0
- **Partial liquidation**: Brings health factor back to 1.1
...
*Still have questions? Join our [Discord community](https://discord.gg/amberfinance) for real-time support from our team and experienced users.*
