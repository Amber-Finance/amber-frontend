---
title: Amber Finance | Terms of Service
description: Complete Terms of Service for Amber Finance including important risk disclosures, user responsibilities, prohibited uses, and binding legal provisions. Last updated August 11, 2025.
---

# Terms of Service

Date of Initial Publication: August 11, 2025

Last Updated: August 11, 2025

These terms and conditions (these “Terms”) constitute a binding legal agreement between each individual, entity, group or association who views, interacts, links to or otherwise uses or derives any benefit from the Site (as defined below) (“Users”) and Amber Finance Foundation, a Cayman Islands company limited by shares (the owner/operator of the Site) (collectively with its successors and assigns, the “Site Operator”).

**Important note**: Amber Finance does not provide any form of compensation, reimbursement, or indemnification for losses, whether arising from market volatility, smart contract vulnerabilities, system errors, hacks, or any other cause. By using the Amber Protocol and its associated services, you acknowledge and agree that all transactions are executed at your own risk, and you bear full responsibility for any resulting losses.

**CRITICAL RISK DISCLOSURE**: Amber Finance operates with NO risk management framework. While the protocol includes liquidation mechanisms, it lacks comprehensive risk controls and protective measures typically found in traditional DeFi protocols. Users can lose their entire deposited funds due to:

- High leverage exposure (up to 12x leverage amplifies both gains and losses)
- Interest rate spikes under high utilization scenarios
- Protocol risks from underlying Bitcoin LST (Liquid Staking Token) protocols

By using Amber Finance, you explicitly acknowledge that you understand these risks and accept full responsibility for any losses incurred. Amber Finance provides no guarantees, insurance, or protection mechanisms for user funds.

## Summary

Among other things, the Terms and Conditions provide that you must:

- be at least eighteen years of age, of sound mental capacity and have all technical knowledge necessary or advisable to understand and evaluate the risks of the Site and Amber;

- agree that the Site is provided for informational purposes only and is not directly or indirectly in control of Mars Hub, Mars Outposts and related blockchain systems or performing or effecting any transactions on your behalf;

- agree that the Site is only being provided as an aid to your own independent research and evaluation of Amber and that no representation or warranty is being made as to the accuracy or completeness of information on the Site;
...
- not hold the Site Operator or any of its representatives or affiliates liable for any damages you suffer in connection with your use of the Site or Amber;
...
- third-party smart contract systems that act as ‘borrowers’ in contract-to-contract (C2C) transactions of the Mars Smart Contract System
...
Note: Amber Finance utilizes the Mars Protocol contracts for its underlying functionality.
...
Amber Finance provides an interface to interact with these systems.
...
“Site” means the web site, web pages, web applications and information and software available at or accessible through the URLs https://amberfinance.io/, https://app.amberfinance.io or any sub-URL of any such URL and any other Amber-related website or web application maintained by the Site Operator.
...
The software code for the Site is available at https://github.com/amber-finance/ and is licensed for use in connection with the Mars Smart Contract System and Mars Hub.

#### 3.3 Marks, Logos and Branding

See branding policy at relevant Amber branding article.
...
In accordance with Cal. Civ. Code Sec. 1789.3, if a User is a California State resident, the User may file grievances and complaints regarding the Site with the California Department of Consumer Affairs, Consumer Information Division; 1625 North Market Blvd., Suite N 112, Sacramento, CA 95834 or by phone at 800-952-5210; or by email to: dca@dca.ca.gov.
