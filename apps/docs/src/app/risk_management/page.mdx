---
title: Amber Finance | Risk Management
...
**What it is**: The risk that underlying Bitcoin LST protocols fail or experience issues.

**How to manage**:

- Research underlying protocols
- Diversify across different Bitcoin LST providers
