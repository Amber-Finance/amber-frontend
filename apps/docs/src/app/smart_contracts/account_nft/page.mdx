---
title: Amber Finance | Account NFT
description: Technical documentation for the Account NFT contract deployed by Amber Finance on Neutron. NFT representation of user accounts.
---
...
_This documentation reflects the Mars Protocol Account NFT contract as deployed by Amber Finance on Neutron._
