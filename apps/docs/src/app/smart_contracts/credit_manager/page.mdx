...
The Credit Manager contract is the core of Amber Finance’s architecture, inherited from Mars Protocol v2. It acts as a proxy between the user, the Red Bank, the liquidation engine, and the Perps contracts — enabling seamless margin management and composable DeFi strategies.
