---
title: Amber Finance | Credit Manager
description: The Credit Manager contract is the core of Amber Finance's architecture, inherited from Mars Protocol v2. Complete technical documentation for the proxy contract enabling margin management and DeFi strategies.
---
...
- **Neutron**: `neutron1et4xza4pge3asumk8yxdx6qm85k9eplk0kathtkheln6znxsqheqfytsza`
