---
title: Amber Finance | Duality Swapper
description: Technical documentation for the Duality Swapper contract providing advanced DEX integration and multi-hop routing for Amber Finance.
openGraph:
  images:
...
_This documentation reflects the Mars Protocol Duality Swapper contract as deployed by Amber Finance on Neutron._
