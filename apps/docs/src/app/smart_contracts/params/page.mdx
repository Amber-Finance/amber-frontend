---
title: Amber Finance | Params
description: Technical documentation for the Params contract managing protocol parameters and configuration for Amber Finance.
---
...
_This documentation reflects the Mars Protocol Params contract as deployed by Amber Finance on Neutron._
