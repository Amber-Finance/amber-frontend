---
title: Amber Finance | Depositing Bitcoin LSTs
description: Depositing Bitcoin Liquid Staking Tokens into Amber Finance allows you to put your assets to work immediately and start earning yields from day one. Complete step-by-step guide to deposits and withdrawals.
---

# Depositing Bitcoin LSTs on Amber Finance

Depositing Bitcoin Liquid Staking Tokens into Amber Finance allows you to put your assets to work immediately and start earning yields from day one.

---

## What Happens When You Deposit

When you deposit Bitcoin LSTs into Amber Finance, your assets:

- **Remain in your control** as collateral
- **Continue earning** their underlying staking rewards
- **Start earning** [Mars Fragments and Neutron Rewards (Points Campaigns)](/user-guide/points-campaigns)
- **Become available** for borrowing other Bitcoin LSTs for looping strategies
- **Can be swapped** to another Bitcoin LST instantly
...
- **Bitcoin LST tokens** to deposit (eBTC, LBTC, solvBTC, etc.)
...
### Step 2: Select Your Bitcoin LST
...
**Base Yield** = Staking rewards from the underlying Bitcoin LST protocol  
**Points Yield** = Mars Fragments + Neutron Rewards from campaigns  
...
- Monitor Neutron Rewards earnings
