...
- **Bitcoin-related tokens (BRTs)** to deposit (eBTC, LBTC, solvBTC, etc.) - you can also pay gas fees with BRTs. Learn more about [depositing BRTs](/user-guide/depositing)
...
- **Immediate yield generation** - Start earning staking rewards  
- **Points accumulation** - Begin earning Mars Fragments and Neutron Points  
- **Collateral availability** - Use deposited assets for borrowing  
