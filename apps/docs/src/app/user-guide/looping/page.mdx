...
description: A guide to using leverage strategies ("looping") to maximize your maxBTC yields on Amber Finance. Learn how to amplify your Bitcoin yields with up to 10x leverage safely.
---
