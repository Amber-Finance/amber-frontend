...
|------|---------|------------------|------------------------|------------|
| <img src="/images/eBTC.png" alt="eBTC" style={{width: '16px', height: '16px', display: 'block', margin: '0 auto'}} /> | **Deposit eBTC** | Neutron Points (\$NTRN),<br />Mars Fragments (\$MARS) | Etherfi Points | 3× |
...
| <img src="/images/pumpBTC.svg" alt="pumpBTC" style={{width: '16px', height: '16px', display: 'block', margin: '0 auto'}} /> | **Deposit PumpBTC** | Neutron Points (\$NTRN),<br />Mars Fragments (\$MARS) | Pump Points | 2× |
...
| <img src="/images/uniBTC.svg" alt="uniBTC" style={{width: '16px', height: '16px', display: 'block', margin: '0 auto'}} /> | **Deposit uniBTC** | Neutron Points (\$NTRN),<br />Mars Fragments (\$MARS) | Bedrock Points | 3× |
