---
title: Amber Finance | Swapping Bitcoin LSTs
description: Swapping Bitcoin LSTs on Amber Finance allows you to exchange one Liquid Staking Token for another directly from your wallet. This is a simple, non-leveraged way to adjust your Bitcoin LST exposure.
---

# Swapping Bitcoin LSTs

Swapping Bitcoin LSTs on Amber Finance allows you to exchange one Liquid Staking Token for another directly from your wallet. This is a simple, non-leveraged way to adjust your Bitcoin LST exposure.
...
2. **Select "From" token** - Choose the Bitcoin LST you want to trade
3. **Select "To" token** - Choose the Bitcoin LST you want to receive
...
- **Real-time pricing** - Live exchange rates between all Bitcoin LST pairs
