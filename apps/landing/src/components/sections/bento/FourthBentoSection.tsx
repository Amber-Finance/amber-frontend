...
export function FourthBentoSection({
  className,
  config = GLOBE_CONFIG,
}: {
  className?: string
  ...
  return (
    <div
      className={cn(
        'absolute inset-0 mx-auto aspect-[1/1] w-full max-w-[600px] h-full opacity-60 hover:opacity-100 transition-all duration-300',
        className,
      )}
    >
      <canvas
